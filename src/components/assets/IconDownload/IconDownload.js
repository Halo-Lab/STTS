...
const IconDownload = () => {
  return (
    <svg width="16" height="16" className={s.size} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        stroke="#2CD351" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M5.5 8.5L8 11L10.5 8.5" stroke="#2CD351" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M8 1.5V10.5" stroke="#2CD351" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
